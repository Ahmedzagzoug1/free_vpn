...
import 'package:vpn_basic_project/pages/connected_network_ip_info_page.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          leading: InkWell(
            onTap: () {
              Get.to(()=>ConnectedNetworkIpInfoPage());
            },
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Text(
            homeController.vpnconnectionState.value==VpnEngine.DISCONNECTED ?
            'Not Connected':homeController.vpnconnectionState.replaceAll("_", " ").toUpperCase(),
            style: TextStyle(fontSize: 13,color: Colors.white),
          ),
        ),
        Obx(()=>TimerWidget(initTimerNow:
        homeController.vpnconnectionState.value==VpnEngine.CONNECTED  ))
      ],
    );
  }
}
